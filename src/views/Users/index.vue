...
import { deleteUserById, getUsers, updateUserById } from '@/services/http.service'
      ...
      <tr v-for='(user, index) in users'>
        ...
        <td>
          <div class='form-check form-switch'>
            <input v-model='user.active' @change='updateUserStatus(user.active, user._id)' class='form-check-input' type='checkbox'>
          </div>
        </td>
